...
const SCHOOLS = {
  ...
  "ecole-de-finance": {
    ...
    agree: true,
    niveaux: ["BTS", "Licence"],
    filieres: ["Génie Logiciel", "Systèmes et Réseaux", "Génie Industriel et Maintenance"],
    duree: "BTS : Bac+2, 4 semestres · Licence professionnelle : 180 crédits, 6 semestres (source : aua-universities.org)",
    admission: "Sur dossier en 4 étapes : choix de la filière, retrait de la fiche d'inscription (étude du dossier : 10 000 FCFA), dépôt du dossier (acte de naissance, certificat de nationalité, relevés et attestations de diplôme, lettre de motivation, photos), puis inscription pédagogique.",
    frais: "Non communiqué publiquement (hors frais de dossier de 10 000 FCFA).",
  ...
  "bakpessi": {
    ...
    agree: true,
    niveaux: ["BTS", "Licence Professionnelle", "Master Professionnel"],
    filieres: ["Maintenance Informatique & Réseaux", "Développement d'Applications", "Informatique Industrielle", "Informatique de Gestion", "Électronique", "Électrotechnique"],
    duree: null,
    admission: "Sur dossier (relevé de notes du Bac, diplôme, acte de naissance, photo, pièce d'identité, lettre de motivation, CV)",
    frais: "Non communiqué publiquement.",
    site: "https://institut-bakpessi.com/",
